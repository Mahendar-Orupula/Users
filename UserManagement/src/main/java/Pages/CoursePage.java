...
public class CoursePage extends BaseTest
{
	...
	public void CourseUpdate() throws InterruptedException
	{
		...
		WebElement Description1=Description;
		Description1.sendKeys(Keys.chord(Keys.CONTROL, "a"));
		Description1.sendKeys(Keys.DELETE);
		Description1.sendKeys(Duration);
		WaitTil(2000);
		CourseUpdate.click();
		WaitTil(2000);
		UM.popupContent();
